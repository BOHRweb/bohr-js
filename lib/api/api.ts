...
export interface InternalTransactionType {
    ...
    gasPrice?: string;
    /**
     * The value being passed, in nano BR
     * @type {string}
     * @memberof InternalTransactionType
     */
    value?: string;
...
export interface TransactionLimitsType {
    ...
    /**
     * The minimum transaction fee in nano BR
     * @type {string}
     * @memberof TransactionLimitsType
     */
    minTransactionFee?: string;
    /**
     * The amount of nano BR required to burn for delegate registration
     * @type {string}
     * @memberof TransactionLimitsType
     */
...
export interface TransactionResultType {
    ...
    gasUsed?: string;
    /**
     * The transaction fee in nano BR. For VM transactions, this field is zero
     * @type {string}
     * @memberof TransactionResultType
     */
    fee?: string;
...
export interface TransactionType {
    ...
    to?: string;
    /**
     * Transaction value in nano BR
     * @type {string}
     * @memberof TransactionType
     */
    value?: string;
    /**
     * Transaction fee in nano BR. For CREATE/CALL, this field is zero; use gas instead
     * @type {string}
     * @memberof TransactionType
     */
    fee?: string;
...
export const WalletApiFp = function(configuration?: Configuration) {
    return {
        ...
        broadcastRawTransactionDeprecated(raw: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<DoTransactionResponse> {
            const localVarFetchArgs = WalletApiFetchParamCreator(configuration).broadcastRawTransactionDeprecated(raw, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        createAccountDeprecated(name?: string, privateKey?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<CreateAccountResponse> {
            const localVarFetchArgs = WalletApiFetchParamCreator(configuration).createAccountDeprecated(name, privateKey, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        deleteAccountDeprecated(address: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<DeleteAccountResponse> {
            const localVarFetchArgs = WalletApiFetchParamCreator(configuration).deleteAccountDeprecated(address, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const WalletApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        broadcastRawTransactionDeprecated(raw: string, options?: any) {
            return WalletApiFp(configuration).broadcastRawTransactionDeprecated(raw, options)(fetch, basePath);
        },
        /**
         * Call a VM contract.
         * @summary Call a contract
         ...
         * @throws {RequiredError}
         */
        createAccountDeprecated(name?: string, privateKey?: string, options?: any) {
            return WalletApiFp(configuration).createAccountDeprecated(name, privateKey, options)(fetch, basePath);
        },
        /**
         * Registers as a delegate
         * @summary Register as delegate
         ...
         * @throws {RequiredError}
         */
        deleteAccountDeprecated(address: string, options?: any) {
            return WalletApiFp(configuration).deleteAccountDeprecated(address, options)(fetch, basePath);
        },
        /**
         * Returns accounts in the wallet.
         * @summary List all accounts in wallet
...
export class WalletApi extends BaseAPI {
     ...
     * @memberof WalletApi
     */
    public broadcastRawTransactionDeprecated(raw: string, options?: any) {
     ...
     * @memberof WalletApi
     */
    public createAccountDeprecated(name?: string, privateKey?: string, options?: any) {
     ...
     * @memberof WalletApi
     */
    public deleteAccountDeprecated(address: string, options?: any) {
